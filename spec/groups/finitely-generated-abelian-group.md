...
---
`FinGenAbGroup` is currently documented in the OSCAR v1.7 profile through the rosetta-stone corpus. This page records the present encoding shape and should be read as a profile-specific type description.

## Encoding Notes

- Set `_type` to `"FinGenAbGroup"` when this type appears at the root of a serialized object.
