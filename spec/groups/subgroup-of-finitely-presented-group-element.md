---
title: Elements of Subgroups of Finitely Presented Groups (`OSCAR v1.4-v1.8`)
...
- Set `_type` to `"SubFPGroupElem"` when this type appears at the root of a serialized object.
